...
\end{center}
 ...
 \newline
 Now,we will solve this question using multiplication rule in probability,For that we will use a table.Let I be probability in individual trial(of getting 6 or not getting 6). So,if we got 6 then I=$\frac{1}{6}$ and if we did not get 6 then I=
 $\frac{5}{6}$.
\begin{table}[ht]
\centering
