...
\end{center}
 ...
 \newline
 Now,we will solve this question using multiplication rule in probability.Let I be probability in individual trial. So,if we got 6 then I=$\frac{1}{6}$ and if we did not get 6 then I=
 $\frac{5}{6}$.
\begin{table}[ht]
\centering
